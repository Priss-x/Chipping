...
public class ProductoController {
    ...
    public ResponseEntity<List<ProductoResponseDTO>> buscaPorNombre(@RequestParam String nombre) {
        return ResponseEntity.ok(productoService.buscaPorNombre(nombre));
    }

    @GetMapping("/buscar/precio")
    public ResponseEntity<List<ProductoResponseDTO>> buscarPorPrecios(@RequestParam Integer min, @RequestParam Integer max)
    {
        return ResponseEntity.ok(productoService.buscaPorPrecio(min,max));
    }

    @GetMapping("/buscar/categoria")
    public ResponseEntity<List<ProductoResponseDTO>> buscarPorCategoriaDesc(@RequestParam String categoria)
    {
